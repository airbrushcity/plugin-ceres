...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    validateData() {
      ...
      _services_ValidationService__WEBPACK_IMPORTED_MODULE_2__["default"].validate($("#newsletter-input-form_" + this._uid)).done(() => {
        ...
        invalidFields.filter(field => {
          ...
          if (field.type === '!regex') {
            _services_NotificationService__WEBPACK_IMPORTED_MODULE_1__["default"].error(this.$translate("Ceres::Template.newsletterNotAllowedCharacters", {
              name: field.name
            }));
          }
        });
    ...
    save() {
      ...
      Object(_helper_executeReCaptcha__WEBPACK_IMPORTED_MODULE_3__["executeReCaptcha"])(this.$el).then(recaptchaToken => {
...
var render = function render() {
  ...
  return _c("form", {
    ...
    attrs: {
      for: "first-name-input_" + _vm.uniqueId
    }
    ...
    attrs: {
      for: "last-name-input_" + _vm.uniqueId
    }
    ...
    attrs: {
      for: "email-input-id_" + _vm.uniqueId
    }
    ...
    attrs: {
      for: "input-username_" + _vm.uniqueId
    }
  }, [_c("span", {
    staticClass: "visually-hidden"
  }, [_vm._v("\n                      " + _vm._s(_vm.$translate("Ceres::Template.newsletterHoneypotLabel")) + "\n                    ")])])])]), _vm._v(" "), _vm.showPrivacyPolicyCheckbox ? _c("div", {
    staticClass: "col-12"
  }, [_c("div", {
    ...
    attrs: {
      for: "privacy-policy-accept-id_" + _vm.uniqueId
    },
    domProps: {
