  ...
  methods: {
    ...
    setPropertiesForTotals(newBasketItems) {
      ...
      for (const basketItem of newBasketItems) {
        ...
        (_basketItem$variation = basketItem.variation.data.properties) === null || _basketItem$variation === void 0 ? void 0 : _basketItem$variation.forEach(property => {
          if (this.isInBasketItemOrderParams(basketItem, property) && (Object(_helper_OrderPropertyHelper__WEBPACK_IMPORTED_MODULE_1__["isAdditionalCosts"])(property) || !Object(_helper_OrderPropertyHelper__WEBPACK_IMPORTED_MODULE_1__["hasVat"])(property) && App.useVariationOrderProperties)) {
            ...
            if (existingProperty) {
              ...
              !Object(_helper_OrderPropertyHelper__WEBPACK_IMPORTED_MODULE_1__["hasVat"])(property) ? this.displayedPropertiesWithoutTax.push(newProperty) : this.displayedProperties.push(newProperty);
            }
          }
        });
      }
