...
/* harmony import */ var _SalutationSelect_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SalutationSelect.vue */ "./resources/js/src/app/components/customer/SalutationSelect.vue");
/* harmony import */ var _customer_CountrySelect_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../customer/CountrySelect.vue */ "./resources/js/src/app/components/customer/CountrySelect.vue");
/* harmony import */ var _VatId_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./VatId.vue */ "./resources/js/src/app/components/customer/VatId.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    SalutationSelect: _SalutationSelect_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    CountrySelect: _customer_CountrySelect_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
    VatId: _VatId_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
  },
  props: {
    defaultCountry: {
      type: String,
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    optionalFields() {
      ...
      if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.optionalAddressFields[iso])) {
    ...
    requiredFields() {
      const iso = this.selectedCountry.isoCode2.toLowerCase();
      if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.requiredAddressFields[iso])) {
  ...
  methods: {
    ...
    transformTranslation(translationKey, addressKey) {
      const translation = _services_TranslationService__WEBPACK_IMPORTED_MODULE_1__["default"].translate(translationKey);
...
/* harmony import */ var _AddressInputGroup_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AddressInputGroup.vue */ "./resources/js/src/app/components/customer/AddressInputGroup.vue");
...
/* harmony import */ var _services_ModalService__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/ModalService */ "./resources/js/src/app/services/ModalService.js");
/* harmony import */ var _AcceptPrivacyPolicyCheck_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./AcceptPrivacyPolicyCheck.vue */ "./resources/js/src/app/components/customer/AcceptPrivacyPolicyCheck.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "registration",
  components: {
    AddressInputGroup: _AddressInputGroup_vue__WEBPACK_IMPORTED_MODULE_4__["default"],
    AcceptPrivacyPolicyCheck: _AcceptPrivacyPolicyCheck_vue__WEBPACK_IMPORTED_MODULE_8__["default"]
  },
  ...
  methods: {
    validateRegistration() {
      _services_ValidationService__WEBPACK_IMPORTED_MODULE_0__["default"].validate(this.$refs.registrationForm).done(() => {
        if (!this.enableConfirmingPrivacyPolicy || this.privacyPolicyAccepted) {
          ...
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].error(this.$translate("Ceres::Template.contactAcceptFormPrivacyPolicy", {
            hyphen: "&shy;"
          }));
        }
      }).fail(invalidFields => {
        if (!Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isNullOrUndefined"])(this.$refs.passwordHint) && invalidFields.indexOf(this.$refs.passwordInput) >= 0) {
          this.$refs.passwordHint.showPopper();
        }
        const invalidFieldNames = this.getInvalidFieldNames(invalidFields);
        if (invalidFieldNames.length > 0) {
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].error(this.$translate("Ceres::Template.checkoutCheckAddressFormFields", {
    ...
    sendRegistration() {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_5__["default"].post("/rest/io/customer", userObject).done(response => {
        _services_ApiService__WEBPACK_IMPORTED_MODULE_5__["default"].setToken(response);
        if (!response.code) {
          document.dispatchEvent(new CustomEvent("onSignUpSuccess", {
            detail: userObject
          }));
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].success(this.$translate("Ceres::Template.regSuccessful")).closeAfter(3000);
          if (document.getElementById(this.modalElement) !== null) {
            _services_ModalService__WEBPACK_IMPORTED_MODULE_7__["default"].findModal(document.getElementById(this.modalElement)).hide();
          }
          ...
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].error(this.$translate("Ceres::Template.regError")).closeAfter(10000);
        }
        this.isDisabled = false;
      }).fail(error => {
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].error(error.error).closeAfter(10000);
        this.isDisabled = false;
      });
    },
    setAddressDataField({
    ...
    initModalEventListeners() {
      const modal = _services_ModalService__WEBPACK_IMPORTED_MODULE_7__["default"].findModal(document.getElementById(this.modalElement));
      if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_2__["isDefined"])(modal)) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created() {
    ...
    if (Object(_helper_utils__WEBPACK_IMPORTED_MODULE_1__["isNullOrUndefined"])(selectedSalutation)) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getVatPrefix(value) {
      var _this$vatCodes2;
      let result = "";
      (_this$vatCodes2 = this.vatCodes) === null || _this$vatCodes2 === void 0 ? void 0 : _this$vatCodes2.forEach(vatCode => {
