...
/* harmony import */ var _helper_getSlotData__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../helper/getSlotData */ "./resources/js/src/app/helper/getSlotData.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({
    ...
    itemSlotData: Object(_helper_getSlotData__WEBPACK_IMPORTED_MODULE_13__["getSlotData"])('item-data'),
...
var render = function render() {
  ...
  return _c("article", {
    ...
    }, [_c("span", [_vm._v(_vm._s(_vm.$translate("Ceres::Template.singleItemContent")) + " " + _vm._s(_vm.item.unit.content))]), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.item.unit.names.name))]), _vm._v(" "), _vm.item.variation.mayShowUnitPrice ? _c("span", [_vm._v("(" + _vm._s(_vm.basePrice) + ")")]) : _vm._e()]) : _vm._e(), _vm._v(" "), _c("div", {
      staticClass: "category-unit-price small"
    }, [_c("span", [_vm._v("** Versandgewicht: ")]), _vm._v(" "), _c("span", [_vm._v(_vm._s(_vm.item.variation.weightG) + " ")]), _vm._v(" "), _c("span", [_vm._v("Gramm.")])]), _vm._v(" "), _c("add-to-basket", {
      attrs: {
        "variation-id": _vm.item.variation.id,
        "is-salable": !!_vm.item.filter && _vm.item.filter.isSalable,
        "has-children": !!_vm.item.item && _vm.item.item.salableVariationCount > 1,
